...
public class FindFacil {
	...
	public static void main(String[] args) {
		...
		System.out.print("Ingrese numero a buscar dentro del arreglo: ");
		numx=Input.get_int();
		flag = buscaFacil(numx,nums);
		if (flag==1) {
			System.out.print("Numero "+numx+" se encuentra en el arreglo");
		}else System.out.print("Numero "+numx+" NO se encuentra en el arreglo");
	}
	
	public static int buscaFacil(int numx, int[] nums) {
		int f=0;
